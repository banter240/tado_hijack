...
References:
  - Magnus formula: Bolton (1980), valid −30…+35 °C, error < 0.1 % over water
  - Building physics thresholds: fRSI ≈ 0.70–0.85, mid-EU housing stock
...
# Mold risk thresholds — dew point spread (T_room − Td) in °C
_MOLD_SPREAD_NONE: float = 7.0  # > 7 °C → no risk
_MOLD_SPREAD_LOW: float = 5.0  # 5–7 °C → low
_MOLD_SPREAD_MEDIUM: float = 3.0  # 3–5 °C → medium  /  ≤ 3 °C → high
